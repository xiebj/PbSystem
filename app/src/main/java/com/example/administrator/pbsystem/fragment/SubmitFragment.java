...
public class SubmitFragment extends Fragment {
    ...
    private View submitLayout = null;
    //手动注入班表时间
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //判断以缓存布局减少资源消耗
        Log.d("tag", "oncreateviewSubmit");
        if (submitLayout == null) {
            Log.d("null", "yes");
            submitLayout = inflater.inflate(R.layout.submit_layout,
                    container, false);
            //获得列头的控件
            ...
            save.setOnClickListener(new OnSaveClick());
    ...
    public class OnSaveClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            Toast.makeText(getActivity(), R.string.hint, Toast.LENGTH_SHORT).show();
        }
    }
}
